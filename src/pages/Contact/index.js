      ...
      <div className='Contact'>
        ...
        <Section>
          ...
          <form className='Contact-form' method='POST' action='https://formspree.io/carlosvillu@gmail.com'>
            <Input type='email' name='email' placeholder={i18n.t('CONTACT_EMAIL_PLACEHOLDER')} />
            <textarea className='Contact-textare' name='message' placeholder={i18n.t('CONTACT_MESSAGE_PLACEHOLDER')} />
